...
\begin{center}
   \label{table:mag3}
   \table}{Tabela 1: Magični kvadrat reda 3}
   \end{center}
   \begin{center}
...
\begin{center}
   \label{table:kubera}
   \title{Tabela 3: Kvadrat Kubera-Kolam}
   \maketitle
   \captionof{table}{Tabela 3: Kvadrat Kubera-Kolam}
   \begin{tabular}{|c|c|c|}\hline
    23 & 28 & 21 \\\hline 
    22 & 24 & 26 \\\hline
    27 & 20 & 25    \\\hline
...
\begin{center}
   \label{fig:durer}
   \title{Slika 1: Dürerjev magični kvadrat}   
   \maketitle
\end{center}
\begin{center}
...
% - oznaka: fig:sagrada
   ...
   begin{center}
   \label{fig:sagrada}
   \title{Slika 2: Pasijonska fasada, Sagrada Família}
   \begin{center}
      {figure}{Slika 2: Pasijonska fasada, Sagrada Família}
   \end{center}
...
\newtheorem{definicija}[izrek]{Definicija}
   ...
   Magični kvadrat je \emph{panmagičen}, če je magična vsota enaka tudi za vse podkvadrate velikosti $2 \times 2$.
   \end{definition}
...
\begin{proof}
   ...
   števil enaka
   \[
      1+2+3+\dots+n^2=\sum_{k=1}^{n^2}k=\frac{n^2(n^2+1)}{2}.
   \]
   Ker imamo v kvadratu $n$ vrstic z enako vsoto, je vsota števil v eni vrstici
   enaka
   \[
      M_2(n) = \frac{1}{n} \cdot \frac{n^2(n^2+1)}{2} = \frac{n(n^2+1)}{2}.
   \]
\end{proof}
...
!!
Kvadratu v tabeli $4$ ustrezata konstanti $A=20$ in $D=1$.
